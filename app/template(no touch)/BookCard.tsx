...
export default function BookCard({ book }: { book: Book }) {
  ...
  useEffect(() => {
    ...
    a.addEventListener("loadedmetadata", () => setDur(formatMM(a.duration)));
  }, [book.audioLink]);
  ...
  return (
    <Link className="for-you__recommended--books-link" href={`/book/${book.id}`}>
      ...
      <figure className="book__image--wrapper" style={{ marginBottom: 8, width: "100%", height: 172 }}>
        <img
      ...
      <div className="recommended__book--details-wrapper">
        <div className="recommended__book--details">
          ...
          <div className="recommended__book--details-text">{dur}</div>
        </div>
        <div className="recommended__book--details">
          <div className="recommended__book--details-icon">
